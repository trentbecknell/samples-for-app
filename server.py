    ...
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .result { margin-top: 30px; padding: 20px; background: #f5f5f5; border-radius: 12px; display: none; }
            .result.show { display: block; }
            .result h3 { color: #333; margin-bottom: 15px; }
            .result pre { background: white; padding: 15px; border-radius: 8px; overflow-x: auto; white-space: pre-wrap; word-wrap: break-word; }
            ...
            .api-link { margin-top: 20px; padding: 15px; background: #f0f0f0; border-radius: 8px; text-align: center; }
    ...
    <body>
        <div class="container">
            <div class="card">
                ...
                <p class="subtitle">Create AI-powered music compositions</p>
                ...
                <form id="compositionForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="length_bars" value="8" min="4" max="32">
                    </div>
